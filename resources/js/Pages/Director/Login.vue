...
const submit = () => {
  form.post(route('director.login.post'))
}
</script>
  ...
  <div class="min-h-screen bg-white flex items-center justify-center p-4">
    ...
    <div class="relative w-full max-w-md">
      ...
      <div class="text-center mb-8">
        ...
        <h1 class="text-3xl font-bold text-gray-900 tracking-tight">Portal del Director</h1>
        <p class="text-gray-500 mt-2 text-sm">Accede para gestionar tu institución</p>
      </div>

      <!-- Alerta de éxito (tras registro) -->
      <div v-if="success"
      ...
      <div class="bg-white border border-gray-200 rounded-2xl p-8 shadow-sm">
        ...
        <form @submit.prevent="submit" class="space-y-5">
          ...
          <p class="text-center text-sm text-gray-500 pt-1">
            ...
            <Link :href="route('director.register')" class="text-gray-800 hover:text-gray-900 font-medium transition-colors">
